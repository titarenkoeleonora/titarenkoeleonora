...
| ------------- | ------------- | ------------- | ----- |
| [What To Watch](https://github.com/titarenkoeleonora/html-academy_what-to-watch-4) | Application for watching movies. | React, Redux, Jest, Enzyme, Webpack |
| [Promotional page Дикси](https://github.com/titarenkoeleonora/test-merkury) | | Promotional page of the action in the Dixy chain of stores. (Completed as part of the test task) | HTML, SCSS, React |
| [Калькулятор накоплений](https://github.com/titarenkoeleonora/test_vc.ru) | Responsive page with savings calculator. (Completed as part of the test task) | HTML, SCSS, JavaScript (ES6), Webpack |
